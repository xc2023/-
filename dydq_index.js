...
function row(it){var d=document.createElement('div');d.className='row';d.innerHTML='<div class="sposter"><img loading="lazy" src="'+(it.img||'')+'">'+(it.tag?'<span class="sbadge">'+it.tag+'</span>':'')+'</div><div class="sinfo"><div class="sname">'+it.title+'</div><div class="smeta">'+(it.desc||'')+'</div></div>';d.onclick=function(){openVod(it)};return d}
